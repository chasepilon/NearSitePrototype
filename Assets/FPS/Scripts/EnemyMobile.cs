...
public class EnemyMobile : MonoBehaviour
{
    ...
    [Tooltip("New speed an enemy takes on once a target is detected")]
    public float alertSpeed = 12f;
    ...
    {
        m_EnemyController.m_NavMeshAgent.speed = alertSpeed;
    ...
    void OnLostTarget()
    {
        ...
        m_EnemyController.ChangePatrolPath();
    }
